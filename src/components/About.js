  ...
  return (
    <div className="bg-black text-white text-center py-5">
      <Container>
        ...
        <p>
          Continuing my education and professional growth, I am currently pursuing a NREMT paramedic certification, scheduled to be completed by August 2023. Alongside my studies, I have taken on the exciting challenge of attending a software engineering bootcamp at Flarion, focusing on developing my skills in the tech field. This pivot into technology offers me a unique perspective and enables me to blend my passion for healthcare with my growing interest in software engineering.
        </p>
        <p>
        ...
        <p>
          I am delighted to showcase my experiences, achievements, and projects through this portfolio website. I hope you find inspiration in my journey and witness the diverse skill set I bring to the table. Thank you for visiting, and please feel free to reach out if you have any questions or opportunities you'd like to discuss. Let's connect and make a difference together.
        </p>
      </Container>
    </div>
  );
